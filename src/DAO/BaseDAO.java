...
//Esta clase DAO la van a implementar las clases que se involucren con la BBDD (user y review),
...
//Utiliza un tipo generico <T> que sera definido por las subclases
